    ...
    <>
      <div className="bg-white rounded-lg shadow-md p-8 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-8">
          ...
          <Button onClick={handleOpenModal} className="flex-1 bg-gray-200 text-dark hover:bg-gray-300">
            Ubah Kata Sandi
          </Button>
        </div>
      </div>
        ...
        <Modal.Body>
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <div className="flex justify-end gap-4 pt-4">
              <Button color="gray" onClick={handleCloseModal}>Batal</Button>
              <Button type="submit" className="bg-primary" isProcessing={isChangingPassword}>
                Simpan Perubahan
              </Button>
            </div>
          </form>
